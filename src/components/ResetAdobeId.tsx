...
export interface ResetAdobeIdProps
  extends React.Props<ResetAdobeIdProps>,
...
export class ResetAdobeId extends React.Component<
  ResetAdobeIdProps,
  ResetAdobeIdState
> {
  constructor(props) {
  ...
  render() {
    const { patron, fetchError, responseBody } = this.props;
    ...
    return (
      <div className="patron-actions">
        ...
        {patron ? (
          ...
          <p>
            <b>Search for a patron to begin.</b>
          </p>
        )}
      </div>
    );
...
const ConnectedResetAdobeId = connect<
  ResetAdobeIdStateProps,
  ResetAdobeIdDispatchProps,
  ResetAdobeIdOwnProps
>(
