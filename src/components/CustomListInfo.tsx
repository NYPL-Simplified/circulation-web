...
export default function CustomListInfo({
  ...
  /** After deleteList deletes the current list,
   * it navigates the user to the edit form of the next
   * list down in the sidebar. If there is no next list,
   * it navigates the user to the create form. */
